...
$row2=$res2->fetch_row();
   ...
   if($amt > $row1['5'])
  {
   ...
   else
    {
       ...
       $sac = $row1['1'];
       $rac = $row2['1'];
       $linknew=new mysqli("localhost","root","","basicbankingsystem-main") or die("DATA NOT FOUND");
    ...
    .msg
 {
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark shadow-lg mb-3">
    ...
    <a href="#" class="navbar-brand">
      ...
      <!-- Logo Text -->
      <span class="text-uppercase font-weight-bold">BANK OF SPAIN</span>
    </a>
  ...
  <?php
  $link1=new mysqli("localhost","root","","basicbankingsystem-main") or die("DATA NOT FOUND");
  ...
  <div class='col-md-5' style="margin-right: 57px;">
  ...
  $link2=new mysqli("localhost","root","","basicbankingsystem-main") or die("DATA NOT FOUND");
  $res2=$link2->query("select * from user where id=$rid");
  $row2=$res2->fetch_row();
  ?>
  <div class='col-md-4' style="margin-right: 115px;">
