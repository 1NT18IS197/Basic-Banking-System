...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark shadow-lg mb-3">
    ...
    <span class="navbar-toggler-icon"></span>
     ...
     <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
        ...
        &nbsp
        &nbsp
        <li class="nav-item"><a href="user.php"> <button type="button" class="btn btn-warning m-2">USER'S DETAIL</button></a></li>
...
$link=new mysqli("localhost","root","","basicbankingsystem-main") or die("DATA NOT FOUND");
$res=$link->query("select * from user");
?>
<div class="container text-center">
<h2><b>SELECT SENDER</b></h2>
